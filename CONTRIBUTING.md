...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-core/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-core` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-core.git
cd scitex-core
pip install -e ".[dev]"
```
